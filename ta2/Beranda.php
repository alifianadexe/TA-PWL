    ...
    <nav class="navbar navbar-dropdown TopMenuUnderline navbar-expand-lg">
        ...
        <div class="container">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-4" href="index.php">Selamat Datang, ...nama...</a></span>
            </div>
                    ...
                    <div class="embla__slide slider-image item" style="margin-left: 1rem; margin-right: 1rem;">
                        <div class="slide-content">
                            ...
                            <div class="item-content">
                                ...
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">Menanam dan merawat tumbuhan adalah salah satu langkah untuk mengurangi kadar CO2 di alam terbuka, selain itu bisa memperbaiki kadar O2 yang kita butuhkan untuk bernafas.</p>
                            </div>
                    ...
                    <div class="embla__slide slider-image item" style="margin-left: 1rem; margin-right: 1rem;">
                        <div class="slide-content">
                            ...
                            <div class="item-content">
                                ...
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">Mematikan air adalah bentuk dari pelestarian air agar tidak terbuang sia-sia apalagi menghemat air bisa menekan pengeluaran bulanan.</p>
                            </div>
                    ...
                    <div class="embla__slide slider-image item" style="margin-left: 1rem; margin-right: 1rem;">
                        <div class="slide-content">
                            ...
                            <div class="item-content">
                                ...
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">Ketika listrik yang tidak digunakan dimatikan akan membantu mengurangi dampak dari pemanasan global karena listrik yang kita gunakan masih berasal dari energi kotor.<br></p>
                            </div>
                    ...
                    <div class="embla__slide slider-image item" style="margin-left: 1rem; margin-right: 1rem;">
                        <div class="slide-content">
                            ...
                            <div class="item-content">
                                ...
                                <p class="mbr-text mbr-fonts-style mt-3 display-7">Menggunakan kendaraan umum tentu bisa mengurangi jumlah polusi kendaraan dan juga mengatasi kemacetan yang ada.<br></p>
                            </div>
