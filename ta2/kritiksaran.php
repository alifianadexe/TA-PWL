...
<head>
  ...
  <meta name="twitter:title" content="Kritik dan saran">
    ...
    <nav class="navbar navbar-dropdown TopMenuUnderline navbar-expand-lg">
        ...
        <div class="container">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black display-4" href="Beranda.php">Selamat Datang, ...nama...</a></span>
            </div>
...
<section data-bs-version="5.1" class="form5 cid-t9Srij4vF6" id="form5-1j">
    
    
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Masukan kritik dan Saranmu</strong></h3>
            
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="Yg24IwXPb0dZa2sPv02hi5gsobZB+hLAdYI5SA/rdRY3BIECH6wo1VJ0hdrIN5nKveKjYpCjJeB2lfAUxMXpHDg+1q7vKuC2zoP7FJXl87x8TSAzxdUxqPP4MG9MFP06">
                    <div class="row">
                        <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Terima kasih atas waktunya untuk menjadikan kami lebih baik!</div>
                    </div>
                    <div class="dragArea row">
                        <div class="col-md col-sm-12 form-group mb-3" data-for="name">
                            <input type="text" name="username" placeholder="username" data-form-field="username" class="form-control" value="" id="username">
                        </div>
                        ...
                        <div class="col-12 form-group mb-3" data-for="textarea">
                            <textarea name="textarea" placeholder="Message" data-form-field="textarea" class="form-control" id="masukan"></textarea>
                        </div>
