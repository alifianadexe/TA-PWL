            ...
            <div class="card col-12 col-md-6">
                <div class="card-wrapper">
                    ...
                    <div class="text-wrapper">
                        <h6 class="card-title mbr-fonts-style mb-1 display-5"><strong>Nomor</strong></h6>
                        <p class="mbr-text mbr-fonts-style display-7">081226347103</p>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6">
                <div class="card-wrapper">
                    ...
                    <div class="text-wrapper">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">recyclebetterbusiness@gmail.com</p>
                    </div>
                </div>
            </div>
            <div class="card col-12 col-md-6">
            ...
            <div class="card col-12 col-md-6">
                <div class="card-wrapper">
                    ...
                    <div class="text-wrapper">
                        ...
                        <p class="mbr-text mbr-fonts-style display-7">
                            Jl. Patriot 2 No H53, Kelurahan Purwosari, Kecamatan Semarang Utara</p>
                    </div>
                </div>
            </div>
        </div>
