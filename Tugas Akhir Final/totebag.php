...
<head>
  ...
  <meta name="twitter:title" content="Totebag">
...
.cid-taIdW1YBWv .mbr-fallback-image.disabled {
  display: none;
}
.cid-taIdW1YBWv .mbr-fallback-image {
  display: block;
...
<section data-bs-version="5.1" class="cid-taIdW1YBWv" id="image1-2k">
    <div class="container">
            ...
            <input type="hidden" name="form_name" value="tukar">
                ...
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <img src="assets/images/totebag.jpg">
                    </div>
            </div>
            <div class="col-12 col-lg">
                <div class="text-wrapper">
                    <h3 class="mbr-section-title mbr-fonts-style mb-3 display-5"><strong>Tote Bag</strong><strong><br></strong></h3>
                        <p>
                            <label>WARNA  &nbsp;</label>
	                        <select name='warna'>
                ...
                <button type="submit" class="btn first" name="tkr_totebag">Tukarkan</button>
            </div>
        </div>
    </div>
</section>
