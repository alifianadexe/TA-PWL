...
.cid-taIdQxzmAy .mbr-fallback-image.disabled {
  display: none;
}
.cid-taIdQxzmAy .mbr-fallback-image {
  display: block;
...
<section data-bs-version="5.1" class="image1 cid-taIdQxzmAy" id="image1-2j">
    <div class="container">
        <form method="POST" action="controller.php">
            ...
            <input type="hidden" name="form_name" value="tukar">
                ...
                <div class="col-12 col-lg-6">
                    <div class="image-wrapper">
                        <img src="assets/images/topijpg.jpg">
                    </div>
                </div>
            <div class="col-12 col-lg">
                ...
                <button type="submit" class="btn first" name="tkr_topi">Tukarkan</button>
            </div>
        </div>
    </div>
</section>
